...
switch(questionType){
    ...
    break;
    case 2: question = `Q What is ${firstNumber} Add to ${secondNumber} ?`
    answer =  firstNumber + secondNumber;
    break;
    case 3: question = `Q What is ${firstNumber} Divided by ${secondNumber} ?`
    answer = firstNumber / secondNumber;
    break;
    case 4: question = `Q What is ${firstNumber} Subtract from ${secondNumber} ?`
    answer =  firstNumber - secondNumber;
    break;
    default :
