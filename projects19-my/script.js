...
// const wifes = "i love my wife payal"
// function countWords(str){
// return str.split(' ').length;
// }
// console.log(countWords(wifes));
...
// // const wife = ["H","a","n","n","a","h"]
// // function reverseArray(arr){
// // return arr.reverse();
// // }
// // console.log(reverseArray(wife));
...
// // }
// // console.log(binarySearch(num,9));


// //Question No 4

// // const rotate = [1,2,3,4,5,6,7]
// // function rotateArray(nums,k){
// // if (k === 0 || nums.length <= 1) {
// // return nums; // No rotation needed if k is 0 or array length is 1 or less
// // }
// // k = k % nums.length; // Calculate the effective rotation step

// // // Get the part of the array that needs to be moved to the front
// // const rotatedPart = nums.slice(nums.length - k);

// // // Get the part of the array that stays at the beginning
...
// // }
// // console.log(rotateArray(rotate,3));
...
// // return count
// // }
// // console.log(countVovel(wife));

// //Question No 7


// // const str = "aeiouu"
// // function subVovel(str){
// // let count = 0;
// // for(let i = 0; i <= str.length - 5; i++){
// // let obj = {"a" : 0, "i" : 0, "u": 0, "e": 0, "o" : 0};

// // for(let j = i ; j < str.length; j++){
// // if(obj[str[j]] != undefined){
// // obj[str[j]] = obj[str[j]] != 0 ? obj[str[j]] + 1 : 1;
// // }else{
// // break
// // }
// // if(obj["a"] > 0 && obj["i"] > 0 && obj["e"] > 0 && obj["u"] > 0 && obj["o"] >0){
// // count++
// // }
// // }
// // }
...
// // }
// // console.log(reverseString(wife));



// //Question No 2

// const arr = "A man, a plan, a canal: Panama"
...
// let solve = str.replace(/[^a-zA-Z0-9]/g, '').toLowerCase()

// // Reverse the remaining characters in the string.
// let resulet = solve.split("").reverse().join("")

// // Compare the reversed string with the original string.
// // If they are the same, the string is a palindrome.
// return solve === resulet   
// }
...
// // }
// // } 
// // const numFibonacci = fibonacci();
// // for(let i = 0; i < t; i++){
// // console.log(numFibonacci.next().value);
// // }


// //Question No 4

// const first = [4,3,2,3,1]
// const second =[2,2,5,2,3,6]

// // This function takes in two arrays, num1 and num2, and returns an array
// // with the number of common elements between the two arrays.
// function commonNum(num1, num2) {
// // Initialize variables to keep track of the number of common elements.+ 
// let n1 = 0, n2 = 0;

// // Loop through each element in num1 and check if it is included in num2.
// // If it is, increment the count for num1.
// for (let i = 0; i < num1.length; i++) {
// if (num1.includes(num2[i]))n1++
// }

// // Loop through each element in num2 and check if it is included in num1.
// // If it is, increment the count for num2.
// for (let j = 0; j < num2.length; j++) {
// if (num2.includes(num1[j]))n2++
// }

// // Return an array with the counts of the common elements between num1 and num2.
// return [n1, n2];
// }
...
// // This function takes in a number and returns the sum of its digits.
// // For example, addDigits(38) would return 11 because 3 + 8 = 11.
// function addDigits(num){

// // First, we check if the input is not a number or is equal to zero. 
// // If so, we return 0 because there are no digits to add.
// if(isNaN(num) || num === 0) {
// return 0;
// }
// // Next, we check if the input is less than 10. If so, we return the input
// // because there is only one digit to add.
// if(num < 10) {
// return num;
// }

// // If the input is greater than or equal to 10, we calculate the sum of its
// // digits by taking the remainder of the input divided by 9. If the remainder is
// // 0, we return 9 because we want to "wrap around" to the digit 9. Otherwise,
...
// // if (number % 2 === 0)return true; // Bug: Semicolon prematurely ends the if statement
// // return false;
// // }
...
// // }
// // // Bug: The use of var causes scope issues
// // }
// // console.log(message);  
...
// // let y = "5";
// // if (x != y) {
// // console.log("Equal"); // Bug: Should use strict equality === to avoid type coercion
// // }
...
// // while (count <= 5) {
// //     console.log(count);
// //     count ++; // Bug: Missing increment statement causes infinite loop
// // }
...
// //     total += items[i]; // Bug: Adding a number and a string
// // }
// // console.log(total);
...
/**
+ * This function checks if the given number is divisible by 2.
+ * 
+ * @param {number} game - The number to be checked.
+ * @returns {boolean} - Returns true if the number is divisible by 2, false otherwise.
+ */
function diviso(game){
// Check if the remainder of dividing the number by 2 is 0.
// If it is 0, the number is divisible by 2 and the function returns true.
// If it is not 0, the number is not divisible by 2 and the function returns false.
if(game%2===0) return true
// If the number is not divisible by 2, the function returns false.
return false
}
...
/**
+ * This function checks if the elements in the given array are sorted in ascending order.
+ * 
+ * @param {Array} arr - The array to be checked.
+ * @returns {boolean} - Returns true if the array is sorted in ascending order, false otherwise.
+ */
function sortArray(arr){
// Initialize a counter to keep track of the number of elements that are out of order.
let count = 0;
...
for(let i = 0; i < n; i++ ){
// Get the index of the next element. If the current index is the last element,
// the next index will be 0.
let nextIndex = (i + 1) % n;

// Compare the current element with the next element.
if(arr[i] > arr[nextIndex]){
// If the current element is greater than the next element, increment the counter.
count++;
}
}
}
...
+ */
function plaicedromeNumber(num) {
// Convert the number to a string.
let numString = num.toString();

// Reverse the string by splitting it into an array of characters,
// reversing the array, and then joining the characters back into a string.
...
/**
+ * This function takes an array of numbers as input and calculates the sum
+ * of each number with the previous number in the array. The modified array
+ * is then returned.
+ *
+ * @param {Array} num - The input array of numbers.
+ * @return {Array} The modified array with the sum of each number with the
+ *                  previous number.
+ */
function sumof1(num) {
// Loop through the array, starting from the second element.
for (let i = 1; i < num.length; i++) {
// Calculate the sum of the current element with the previous element.
num[i] = num[i - 1] + num[i];
}
...
// function baseK(n,k){
// return n.toString(k).split("").reduce((arr ,curr ) => arr += parseInt(curr),0);
// }
// console.log(baseK(34,6));