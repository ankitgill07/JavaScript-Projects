  ...
  const renderTransactions = () => {
    ...
    isCredit ? "C" : "D"
        ...
        <div class="icon"onclick="handleUpdate(${id})">
          <img src="https://raw.githubusercontent.com/anshuopinion/HTML-CSS-JAVASCRIPT-10-PRACTICE-PROJECTS/a3047ef1b565474fe9287a50489db740c5cdc87c/icons/pen.svg" alt="pen">
        </div>
        <div class="icon"onclick="handleDelete(${id})">
          <img src="https://raw.githubusercontent.com/anshuopinion/HTML-CSS-JAVASCRIPT-10-PRACTICE-PROJECTS/a3047ef1b565474fe9287a50489db740c5cdc87c/icons/trash.svg" alt="trash">
        </div>
        </div>
    </div>`;
